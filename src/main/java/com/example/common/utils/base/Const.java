...
public class Const {
	...
	/**
	 * 信息录入流程实例Key 可能多个 用like查询
	 */
	public static final String SERVICE_PROCESSINSTACE_KEY = "service";
	
	/**
	 * 变更流程实例Key
	 */
	public static final String CHANGE_PROCESSINSTACE_KEY = "change";

	/**
	 * 启动成功
	 */
	public static final String START_SUCCEED = "启动成功";
	
	/**
	 * 项目启动
	 */
	public static final String START_FAIL = "启动失败";
	public static final String STOP_SUCCEED = "停止成功";
	 ...
	 * 相册保存路径
	 */
	public static final String ALBUM = path + "\\site\\images\\album";
	/**
	 * 办公人员照片保存路径
	 */
	public static final String POWERPHOTO = path + "\\site\\images\\power";
	/**
	 * 农户人员照片保存路径
	 */
	public static final String PERSONPHOTO = path + "\\site\\images\\person";
	
	/**
	 * 默认照片保存路径
	 */
	public static final String DEFAULTtPHOTO = path + "\\site\\images\\default";
	
	/**
	 * excle导入路径
	 */
	public static final String EXCLEPATH = path + "\\site\\xls\\";
}
